...
const Register = () => {
  ...
  return (
    <div className='h-screen w-full flex items-center justify-center bg-emerald-50 px-4'>
        <form onSubmit={handleSubmit(registerHandler)} className='flex flex-col gap-5 w-full max-w-sm p-8 bg-white rounded-xl border border-emerald-100 shadow-md'>
            <div className='flex flex-col items-center gap-1 mb-1'>
                ...
                <p className='text-sm text-gray-500'>Start shopping with DCom today</p>
            </div>
            ...
            <button
                type='submit'
                className='w-full py-2.5 rounded-lg bg-emerald-700 text-white font-medium text-sm hover:bg-emerald-800 transition-colors duration-200 mt-1'
            >
                Sign Up
            </button>
